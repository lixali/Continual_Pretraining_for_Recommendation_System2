...
folders=("text_alike_after_search" "text_alike_embeddings")
...
for (( leng=1; leng<=max_leng; leng++ )); do
    ...
    pool_embedding="pool_doc_splitted_no_fusin_decoder/pool_doc_output_embedding_${experiment_run}.jsonl"
